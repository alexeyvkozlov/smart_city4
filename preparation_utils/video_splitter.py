...
class VideoSplitter:
  ...
  def frame_extract(self):
    ...
    while vcam.isOpened():
      ...
      fname2 = f'f{self.dir_filer.format_counter(fcounter, digits)}-{uuid.uuid1()}.png'
...
if __name__ == "__main__":
  ...
  #~ входные папаметры
  #~~~~~~~~~~~~~~~~~~~~~~~~
  src_fname1 = 'c:/my_campy/smart_city/smart_city_check_photo_video/person_fall/vtest.avi'
  #~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  dst_dir2 = 'c:/my_campy/smart_city/smart_city_check_photo_video/person_fall/fall91'
  #~~~~~~~~~~~~~~~~~~~~~~~~
