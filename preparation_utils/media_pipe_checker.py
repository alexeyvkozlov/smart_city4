  ...
  def image_check(self):
    ...
    for i in range(img_lst_len):
      ...
      for yodet in yodets.boxes.data.tolist():
        ...
        border_width1 = 0.05*(yox2 - yox1)
        border_height1 = 0.05*(yoy2 - yoy1)
        #~ m - media pipe
        ...
        try:
          ...
          #~~~~~~~~~~~~~~~~~~~~~~~~
          left_hip_x = x1m + int(human_dots[mp_pose.PoseLandmark.LEFT_HIP].x * img_width2)
          left_hip_y = y1m + int(human_dots[mp_pose.PoseLandmark.LEFT_HIP].y * img_height2)
          print('[INFO] 23 - left hip - левое бедро')
          #~~~~~~~~~~~~~~~~~~~~~~~~
          right_hip_x = x1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_HIP].x * img_width2)
          right_hip_y = y1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_HIP].y * img_height2)
          ...
          #~~~~~~~~~~~~~~~~~~~~~~~~
          left_ankle_x = x1m + int(human_dots[mp_pose.PoseLandmark.LEFT_ANKLE].x * img_width2)
          left_ankle_y = y1m + int(human_dots[mp_pose.PoseLandmark.LEFT_ANKLE].y * img_height2)
          print('[INFO] 27 - left ankle - левая лодыжка')
          #~~~~~~~~~~~~~~~~~~~~~~~~
          right_ankle_x = x1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_ANKLE].x * img_width2)
          right_ankle_y = y1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_ANKLE].y * img_height2)
          print('[INFO] 28 - right ankle - правая лодыжка')
          #~~~~~~~~~~~~~~~~~~~~~~~~
          left_heel_x = x1m + int(human_dots[mp_pose.PoseLandmark.LEFT_HEEL].x * img_width2)
          left_heel_y = y1m + int(human_dots[mp_pose.PoseLandmark.LEFT_HEEL].y * img_height2)
          print('[INFO] 29 - left heel - левая пятка')
          #~~~~~~~~~~~~~~~~~~~~~~~~
          right_heel_x = x1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_HEEL].x * img_width2)
          right_heel_y = y1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_HEEL].y * img_height2)
          print('[INFO] 30 - right heel - правая пятка')
          #~~~~~~~~~~~~~~~~~~~~~~~~
          left_foot_index_x = x1m + int(human_dots[mp_pose.PoseLandmark.LEFT_FOOT_INDEX].x * img_width2)
          left_foot_index_y = y1m + int(human_dots[mp_pose.PoseLandmark.LEFT_FOOT_INDEX].y * img_height2)
          print('[INFO] 31 - left foot index - указательный палец левой стопы')
          #~~~~~~~~~~~~~~~~~~~~~~~~
          right_foot_index_x = x1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_FOOT_INDEX].x * img_width2)
          right_foot_index_y = y1m + int(human_dots[mp_pose.PoseLandmark.RIGHT_FOOT_INDEX].y * img_height2)
...
if __name__ == "__main__":
  ...
  src_dir1 = 'c:/my_campy/smart_city/smart_city_check_photo_video/person_fall/fall92'
  #~~~~~~~~~~~~~~~~~~~~~~~~
  #~ model mode
  #~ YOLOv8n -> nano
  #~ YOLOv8s -> small
  ...
  dst_dir2 = 'c:/my_campy/smart_city/smart_city_check_photo_video/person_fall/fall92_out_ratio_2'
