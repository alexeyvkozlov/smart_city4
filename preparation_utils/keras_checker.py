...
class KerasChecker:
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  def __init__(self, src_dir1: str, kerasimg_wh1: int, model_fname1: str, class_labels_lst1: list[str], rep_img_width2: int, rep_img_height2: int, dst_dir2: str):
  ...
  def image_check(self):
    ...
    for i in range(img_lst_len):
      ...
      cv2.rectangle(frame, (0,0), (164,25), (255,255,255), -1)
...
if __name__ == "__main__":
  ...
  # src_dir1 = 'c:/my_campy/smart_city_check_photo_video/fire/fire_check_in'
  src_dir1 = 'c:/my_campy/smart_city/smart_city_check_photo_video/fire/fire104-frames-1sec'
  #~ keras image width,height ширина-высота изображения, на котором произведено обучение keras
  kerasimg_wh1 = 224
  #~ файл с рассчитанными весами
  model_fname1 = 'c:/my_campy/smart_city/fire_weights/20240926_10epochs/model20240926.h5'
  ...
  dst_dir2 = 'c:/my_campy/smart_city/smart_city_check_photo_video/fire/fire104-frames-1sec_out'
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  kchr_obj = KerasChecker(src_dir1, kerasimg_wh1, model_fname1, class_labels_lst1, rep_img_width2, rep_img_height2, dst_dir2)
  #~~~~~~~~~~~~~~~~~~~~~~~~
