...
class YoloTrainer:
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  def __init__(self, src_dir1: str, model_mode1: str, epochs_count1: int, batch_count1: int, img_size1: int):
...
if __name__ == "__main__":
  print('~'*70)
  print('[INFO] YoloTrainer ver.2024.09.16')
  print('~'*70)
  #~~~~~~~~~~~~~~~~~~~~~~~~
  #~ путь к обучающим данным: test train valid: images labels
  src_dir1 = 'c:/dataset_car_accident'
  #~~~~~~~~~~~~~~~~~~~~~~~~
  #~ model mode
  #~ YOLOv8n -> nano
  #~ YOLOv8s -> small
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~
  ytrn_obj = YoloTrainer(src_dir1, model_mode1, epochs_count1, batch_count1, img_size1)
  #~~~~~~~~~~~~~~~~~~~~~~~~
